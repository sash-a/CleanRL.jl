# modified from ReinforcementLearning.jl because it doesn't seem to be exported
# https://github.com/JuliaReinforcementLearning/ReinforcementLearning.jl/blob/a91ec1f470c036dc7cdb37fcd91c686a84ccc1a3/src/ReinforcementLearningZoo/src/algorithms/policy_gradient/multi_thread_env.jl
...
single_state_space(env::MultiThreadEnv) = state_space(first(env.envs))
single_action_space(env::MultiThreadEnv) = action_space(first(env.envs))
